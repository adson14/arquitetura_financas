...
type TransactionElasticSearchRepository struct {
	Client elasticsearch.Client
}

func (t TransactionElasticSearchRepository) Search(reportID string, accountID string, initDate string, endDate string) (dto.SearchResponse, error) {
	layout := "2006-01-02"
